...
const VerticalTabs: React.FC = () => {
  ...
  return (
    <Box className="leaderBoardFlex" sx={{ flexGrow: 1, display: 'flex' }}>
      <Tabs
        orientation="vertical"
        value={value}
        className="verticla_months leaderBoadsTabs"
        onChange={handleChange}
        aria-label="Vertical tabs example disabled "
        sx={{ borderRight: 1, borderColor: 'divider' }}
      >
        <Tab label="January" {...a11yProps(0)} />
        <Tab label="February" {...a11yProps(1)} />
        <Tab label="March" {...a11yProps(2)} disabled />
        <Tab label="April" {...a11yProps(3)} disabled />
        <Tab label="May" {...a11yProps(4)} disabled />
        <Tab label="June" {...a11yProps(5)} disabled />
        <Tab label="July" {...a11yProps(6)} disabled />
        <Tab label="August" {...a11yProps(7)} disabled />
        <Tab label="September" {...a11yProps(8)} disabled />
        <Tab label="October" {...a11yProps(9)} disabled />
        <Tab label="November" {...a11yProps(10)} disabled />
        <Tab label="December" {...a11yProps(11)} disabled />
      </Tabs>
      <Box className="w-100">
        <Box className="d-flex justify-content-between">
          <Box className="switch-field">
            <input type="radio" id="monthly" name="filterLeadarboard" value="monthly" checked />
            <FormLabel htmlFor="monthly">Monthly</FormLabel>
            <input type="radio" id="overall" name="filterLeadarboard" value="overall" />
            <FormLabel htmlFor="overall">Overall</FormLabel>
          </Box>
        ...
        <TabPanel value={value} index={0}>
          <table className="table table-bordered table-responsive leaderboard_table">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>
                  <img src="./images_public/leader1.png" alt="" /> Michael Jenkins
                </td>
                <td>APAC</td>
                <td>115 PTS</td>
              </tr>
